Feature: Find journey by one or more keywords
  ...
  Scenario: Successful search for a journey
    ...
    And a list of existing journeys: port of origin "Oslo", destination "London", content "Cheese" with the client: client name "HM", address "Nyvej 2", contact person "Jens Ole", email "jo@hm.com"
